...
<body>
	<div id="container">
		<%-- <jsp:include page="/WEB-INF/views/includes/header_jstl.jsp" /> --%>
		<c:import url="/WEB-INF/views/includes/header_jstl.jsp"></c:import>
		<div id="wrapper">
			<div id="content">
				<div id="site-introduction">
					<img id="profile" src="${pageContext.servletContext.contextPath }/assets/images/1234.jpg">
					<h2>안녕하세요. 안원휘의  mysite에 오신 것을 환영합니다.</h2>
					<p>
